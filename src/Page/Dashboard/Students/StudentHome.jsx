    ...
    const fetchAllExams = async () => {
      try {
        ...
        const [
          ...
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/unpaidexams`,
            config
          ),
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/totaluserexams`,
            config
          ),
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/expiredexams`,
            config
          ),
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/waittingexams`,
            config
          ),
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/passedexams`,
            config
          ),
          axios.get(
            `https://congozi-backend-6jc5.onrender.com/api/v1/failledexams`,
            config
          ),
        ]);
