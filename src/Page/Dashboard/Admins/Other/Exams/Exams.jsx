...
const AdminExams = () => {
  ...
  const fetchExams = async () => {
    try {
      ...
      const res = await axios.get(
        `https://congozi-backend-6jc5.onrender.com/api/v1/exams`,
        {
          headers: {
  ...
  const handleDeleteExam = async () => {
    ...
    try {
      await axios.delete(
        `https://congozi-backend-6jc5.onrender.com/api/v1/exams/${examToDelete._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://congozi-backend-6jc5.onrender.com/api/v1/exams/${editingExam._id}`,
        {
          title: editedTitle,
          fees: editedFees,
          type: editedType,
