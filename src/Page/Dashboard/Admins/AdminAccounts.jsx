  ...
  const fetchAccounts = async () => {
    try {
      ...
      const response = await axios.get(
        `https://congozi-backend-6jc5.onrender.com/api/v1/accounts`,
        {
          headers: {
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      const response = await axios.delete(
        `https://congozi-backend-6jc5.onrender.com/api/v1/accounts/${accountToDelete._id}`,
        {
          headers: {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      const res = await axios.put(
        `https://congozi-backend-6jc5.onrender.com/api/v1/accounts/${accountToEdit._id}`,
        {
          title: editedTitle,
          fees: editedFees,
