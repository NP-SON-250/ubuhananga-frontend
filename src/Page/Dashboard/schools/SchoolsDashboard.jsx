    ...
    const fetchAllAccounts = async () => {
      try {
        ...
        const [unpaidRes, totalRes, expiredRes, waitingRes] = await Promise.all(
          [
            axios.get(
              `https://congozi-backend-6jc5.onrender.com/api/v1/unpaidaccounts`,
              config
            ),
            axios.get(
              `https://congozi-backend-6jc5.onrender.com/api/v1/totaluseraccounts`,
              config
            ),
            axios.get(
              `https://congozi-backend-6jc5.onrender.com/api/v1/expiredaccounts`,
              config
            ),
            axios.get(
              `https://congozi-backend-6jc5.onrender.com/api/v1/waittingaccounts`,
              config
            ),
          ]
        );
